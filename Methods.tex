\chapter{Methods}
    ...
    The counts get added to bins according to the current detector angle according to this equation: $2(\omega+\theta)$, with $\theta$ being the current detector angle.
