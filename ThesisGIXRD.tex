...
\TitleTop{Dopant Profiles with}
\TitleMiddle{Grazing Incidence X-Ray Diffraction}
%  \TitleBottom{}

% Your research advisor
\Advisor{David Oliphant}

% Your committee members beyond your advisor
\MemberA{Jon Johnson}
\MemberB{Todd Lines}
\ThesisCoordinator{Todd Lines}
...
\Abstract{In this work, grazing incidence X-ray diffraction (GIXRD) is utilized to investigate the 
			depth profile of dopants in silicon. By systematically varying the X-ray incidence angle, 
			one can precisely control the depth penetrated into doped silicon samples. This approach 
			enables a non-destructive analysis of how dopant concentration evolves with depth. The 
			findings provide crucial insights into the distribution and behavior of dopants, which is 
			essential for optimizing semiconductor device performance and fabrication processes.}

% Acknowledge those who helped and supported you
\Acknowledgments{
	Tylyn Smith for her patience in supporting me. 
	Tyler Smith for encouraging me to study physics in university. 
	Brother David Oliphant for his helpful guidance throughout my time spent learning here at BYUI. 
	Brother Jon Johnson for his helpful introduction to solid state physics and computational methods. 
	Lastly, Brother Todd Lines's enduring life and academic advice.
}

\fussy

\usepackage{float} % To correct image positions
\usepackage[inkscapelatex=false]{svg} % To use svg files
\usepackage{tikz}
\usetikzlibrary{angles, quotes, calc, shapes.geometric, patterns}
