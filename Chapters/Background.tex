\chapter{Background}
    ...
    and $d$ is the slit spacing, which are the different varieties of interatomic spacings.
    The interatomic spacings are also the spacings between different planes of atoms as well, instead of only to the nearest neighbors.
