\chapter{Methods}
    ...
    Then thirdly, that the sample is put in its preferred orientation that allows for the silicon structure to be alined with the x-ray beam.
    ...
    \subsubsection*{Method 1: Intensity}
        ...
        This method takes the highest count of the amorphous hump, and the highest count of the crystalline peaks as input parameters, and calculates the ratio of them.
